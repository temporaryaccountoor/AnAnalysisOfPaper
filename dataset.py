...
class DatasetGenerator():
    ...
    def loadData(self):
        ...
        ########
        print(type(train_dataset),type(data_loaders),type(data_loaders['train_dataset']))
        #for _ in range(int(self.noise_rate/2*len(train_dataset))):
          #(data_loaders['train_dataset']).pop(random.choice(data_loaders['train_dataset'].keys()))
        ####################################
