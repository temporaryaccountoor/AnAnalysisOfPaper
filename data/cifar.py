...
class ImbCIFAR10(torchvision.datasets.CIFAR10):
    cls_num = 10
    def __init__(self, root, imb_type='exp', imb_factor=0.01, train=True, transform=None, target_transform=None, download=False, seed=0):
        super(ImbCIFAR10, self).__init__(root, train, transform, target_transform, download)
        np.random.seed(seed)
...
if __name__ == '__main__':
    CIFAR10('./CIFAR10', download=False)
    CIFAR100('./CIFAR100', download=False)
