...
def noisify_cifar10_asymmetric(y_train, noise, random_state=123):
    """mistakes:
        automobile <- truck
        bird -> airplane
        cat <-> dog
...
def noisify_cifar100_asymmetric(y_train, noise, random_state=123):
...
def noisify(dataset='mnist', nb_classes=10, train_labels=None, noise_type=None, noise_rate=0, random_state=123):
